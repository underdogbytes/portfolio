const projects = [
  {
    source: './src/assets/images/projects/colecoes-fauna-do-brasil.png',
  ...
  {
    source: './src/assets/images/projects/renovacao.png',
  ...
  {
    source: './src/assets/images/projects/tempestade-criativa.png',
    tags: ['developer'],
    techs: ['html/css/js'],
  ...
  {
    source: './src/assets/images/projects/show-gospel.png',
    tags: ['developer'],
    techs: ['php', 'laravel'],
