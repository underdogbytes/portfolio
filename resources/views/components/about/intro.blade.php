<section>
  <div class="inner">
      <x-titles.big-underlined
        title="{!! __('about-me.header_title') !!}"
        description="{!! __('about-me.header_subtitle') !!}"
      />

    <div class="intro-about-me__content">
      <img
        src="{{asset('images/bea/02.jpg')}}"
        alt="Mulher com olhos castanhos, cabelo curto preto, franja, olho delineado, batom vermelho e piercing no lábio inferior"
        class="intro-about-me__img"
      />
      <div>
        <h2>
          <small>Under quem?</small>
          <br>
          Designer, artista e engenheira de software.
        </h2>
        <p>
        ...
        <p>Para trabalho ou para dizer um oi, me manda um e-mail:</p>
